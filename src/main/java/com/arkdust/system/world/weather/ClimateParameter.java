...
public record ClimateParameter(float range, float defaultValue, float defaultRate, float mutationChanceCoe, float mutationStrengthCoe, float rateFactor) {
    ...
    public static class ActivatedState implements INBTSerializable<CompoundTag> {
        ...
        public CompoundTag serializeNBT() {
            ...
            tag.putString("climate", ArkdustRegistry.CLIMATE_PARAMETER.getKey(climate).toString());
        ...
        public String toString() {
            return "ActivatedState{" +
                    "climate=" + ArkdustRegistry.CLIMATE_PARAMETER.getKey(climate).toString() +
                    ", value=" + value +
                    ", rate=" + rate +
                    ", rate_fac=" + rateFactor +
                    ", offset=" + offset +
        ...
        public void deserializeNBT(CompoundTag tag) {
            this.climate = ArkdustRegistry.CLIMATE_PARAMETER.get(new ResourceLocation(tag.getString("climate")));
